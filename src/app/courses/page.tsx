...
export default function Courses() {
  return (
    <div className="min-h-screen bg-black py-12 pt-36 relative overflow-hidden">
      {/* Meteors component covering 70% of the screen */}
      <div
        className="fixed z-0"
        style={{
          width: "70vw",
          ...
          left: "15vw", // Center horizontally
        }}
      >
        <Meteors number={20} className="absolute inset-0" />
      </div>
      <h1 className="text-lg md:text-7xl text-center font-sans font-bold mb-8 text-white z-10">
        All {CourseData.courses.length} Courses
      </h1>
